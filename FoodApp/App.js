...
const resOBJ = {
    ...
    "availability": {
      "nextCloseTime": "2023-12-17 22:40:00",
      "opened": true
    },
    "badges": {
      "imageBadges": [
   ...
   const {name,cuisines,avgRating,costForTwo}=resData?.info;
    ...
    return (
        <div className="res-card" style={{backgroundColor:"#FFFDEF"}}>
            ...
            <img className="reslogo" alt="res-logo" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+resData.info.cloudinaryImageId}/>
            <h3>{name}</h3>
            <h4> {cuisines.join(", ")}</h4>
            <h4>{avgRating}</h4>
            <h4>{costForTwo}</h4>
